...
def create_app():
    ...
    logger.info("All blueprints registered successfully: API, Auth, Dashboard, NCBI, Macrogen, Upload, Server, WorkbenchCore, WorkbenchDetailQC, WorkbenchDetailPreprocessing, WorkbenchDetailAlignment, WorkbenchShare, DEG, GSEA, PCA, Counts, Clustering, JobManager, Settings, Pattern, InterestingGenes, and WebSocket")
