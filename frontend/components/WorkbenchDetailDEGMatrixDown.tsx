...
interface WorkbenchDetailDEGMatrixDownProps {
    workbenchId: number;
...
const WorkbenchDetailDEGMatrixDown: React.FC<WorkbenchDetailDEGMatrixDownProps> = ({
    workbenchId,
    comparisonName,
    toolName,
    selectedGenes,
    ...
    const {
        ...
        description: `Significant down-regulated genes from ${comparisonName}`,
    });
    ...
    const fetchDEGResults = useCallback(async (
        ...
        try {
            ...
            const params = new URLSearchParams({
                ...
                filter_type: 'down', // Down-regulated genes
                data_type: 'matrix'
            });
    ...
    const handleGOAnalysis = async (provider: 'david' | 'gprofiler') => {
        ...
        try {
            const result = await apiService.runGOEnrichment(workbenchId, {
                ...
                p_value_cutoff: 0.05,
                description: `Down-regulated genes from ${comparisonName}`,
    ...
    const handleDownload = useCallback(() => {
        ...
        const filename = `${comparisonName}_down_regulated_${selectionType}_${timestamp}.tsv`;
        ...
        <div ref={matrixSectionRef} className="h-full">
            ...
            {!loading && filteredData.length === 0 && (
                <div className="text-center py-12">
                    ...
                    <h4 className="text-lg font-medium text-slate-900 mb-2">No down-regulated genes found</h4>
...
export default WorkbenchDetailDEGMatrixDown;
